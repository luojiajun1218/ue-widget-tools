...
6. For DSL-driven UI, call `ue.ui.review_widget_dsl` and open/use the generated web review output for user approval before writing the asset. This review gate is the UI design approval path for this skill. Create or update the review HTML before any Unreal asset mutation.
